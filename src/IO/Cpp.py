...
class CppExport():
    def __init__(self, model, latexSubs={}, lightSolverOnly=False):
        ...
        self.lightSolverOnly = lightSolverOnly

        self.generateCppFile(model)


    def write(self, path):
        if not self.lightSolverOnly:
            self.storePath = path
...
/***************************************************/
/*                                                 */
/*   File automatically generated by PyR@TE 3.     */
/*   Readable by MadGraph_aMC@NLO in the context   */
/*   of the FeynRules-PyR@TE-MadGraph interface.   */
/*                                                 */
/***************************************************/
