...
class Model(object):
    ...
    def __init__(self, settings, runSettings, idb, realBasis='all'):
        ...
        # Declare an interactive db access object and load it
        # self.idb = Idbquerry(noprint=True)
        self.idb = idb
        
        self.loopDic = {}
        
        #TODO : Improve validate settings
        ...
        # #Definitions of auxiliar quantities for writing the Lagrangian
        # self.Definitions = {}
        ...
        if self.kinMix:
            ...
            for i in range(self.nU):
                for j in range(self.nU):
                    ...
                    # if i <= j:
                        ...
                        # self.kinMat[j,i] = self.kinMat[i,j]
            ...
            # self.kinMat2 = self.kinMat.transpose()*self.kinMat
    ...
    ###############################################################
    # Make all useful functions from Lagrangian and Substitutions #
