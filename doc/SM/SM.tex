...
-  \frac{1221}{800} g_{1}^{4} v

+ \frac{9}{16} g_{1}^{2} g_{2}^{2} v

+ \frac{199}{32} g_{2}^{4} v

-  \frac{103}{40} g_{1}^{2} v \left|{y_t}\right|^{2}

-  \frac{43}{40} g_{1}^{2} v \left|{y_b}\right|^{2}

-  \frac{81}{40} g_{1}^{2} v \left|{y_\tau}\right|^{2}

-  \frac{63}{8} g_{2}^{2} v \left|{y_t}\right|^{2}

-  \frac{63}{8} g_{2}^{2} v \left|{y_b}\right|^{2}

-  \frac{21}{8} g_{2}^{2} v \left|{y_\tau}\right|^{2}

- 20 g_{3}^{2} v \left|{y_t}\right|^{2}

- 20 g_{3}^{2} v \left|{y_b}\right|^{2}
